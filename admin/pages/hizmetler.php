...
$query_rsListe = "SELECT * FROM tablo_hizmetler ORDER BY ID DESC";			
                ...
                <table class="table table-hover" id="dataTablo">
                  <thead>
                    <tr>
                      ...
                      <th>Başlık</th>
                      <th>Sıra No</th>
                      <th><a href="<?php echo sayfa("hizmetler_detay") ?>" class="btn btn-sm btn-info">Yeni Ekle</a></th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php do { ?>
                    <tr>
                      ...
                      <td><?php echo $row_rsListe['Baslik']; ?> <?php admin_ceviri_durum_rozetleri('hizmetler', $row_rsListe['ID']); ?></td>
                      <td><?php echo $row_rsListe['SiraNo']; ?></td>
                      <td>
                        <a href="<?php echo sayfa("hizmetler_detay") ?>&ID=<?php echo $row_rsListe['ID']; ?>" class="btn btn-sm btn-success">Detay</a>
                      <a href="<?php echo sayfa("hizmetler_detay") ?>&ID=<?php echo $row_rsListe['ID']; ?>&islemsil=ok" onClick="return confirm('Emin msiniz?')" class="btn btn-sm btn-danger">Sil</a></td>
                    </tr>
