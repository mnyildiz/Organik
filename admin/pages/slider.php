...
$query_rsListe = "SELECT * FROM tablo_slider ORDER BY ID";			
                ...
                <table class="table table-hover">
                  <thead>
                    <tr>
                      ...
                      <th>Link</th>
                      <th>Sıra No</th>
                      <th><a href="<?php echo sayfa("slider_detay") ?>" class="btn btn-sm btn-info">Yeni Ekle</a></th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php do { ?>
                    <tr>
                      ...
                      <td><?php echo $row_rsListe['Baslik']; ?> <?php admin_ceviri_durum_rozetleri('slider', $row_rsListe['ID']); ?></td>
                      <td><?php echo $row_rsListe['Link']; ?></td>
                      <td><?php echo $row_rsListe['SiraNo']; ?></td>
                      <td>
                        <a href="<?php echo sayfa("slider_detay") ?>&ID=<?php echo $row_rsListe['ID']; ?>" class="btn btn-sm btn-success">Detay</a>
                        <a href="<?php echo sayfa("slider_detay") ?>&ID=<?php echo $row_rsListe['ID']; ?>&islemsil=ok" onClick="return confirm('Emin msiniz?')" class="btn btn-sm btn-danger">Sil</a>
                     </td>
                    </tr>
