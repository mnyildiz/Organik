...
$query_rsListe = "SELECT * FROM tablo_blog ORDER BY ID DESC";			
                ...
                <table class="table table-hover" id="dataTablo">
                  <thead>
                    <tr>
                      ...
                      <th>Tarih</th>
                      <th><a href="<?php echo sayfa("blog_detay") ?>" class="btn btn-sm btn-info">Yeni Ekle</a></th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php do { ?>
                    <tr>
                      ...
                      <td><?php echo strip_tags($row_rsListe['Baslik']); ?> <?php admin_ceviri_durum_rozetleri('blog', $row_rsListe['ID']); ?></td>
                      <td>
                      ...
                      <td>
                        <a href="<?php echo sayfa("blog_detay") ?>&ID=<?php echo $row_rsListe['ID']; ?>" class="btn btn-sm btn-success">Detay</a>
                      <a href="<?php echo sayfa("blog_detay") ?>&ID=<?php echo $row_rsListe['ID']; ?>&islemsil=ok" onClick="return confirm('Emin msiniz?')" class="btn btn-sm btn-danger">Sil</a></td>
                    </tr>
