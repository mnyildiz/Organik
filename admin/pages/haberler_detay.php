...
if ((isset($_POST["islem"])) && ($_POST["islem"] == "kaydet")) {
  ...
  $insertSQL = sprintf("INSERT INTO tablo_haberler (Resim, BuyukResim, Baslik, KisaBilgi, Detay, Tarih, SiraNo, Slider, Kategori) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       escape($Resim, "text"),
...
if ((isset($_POST["islem"])) && ($_POST["islem"] == "guncelle")) {
  ...
  $updateSQL = sprintf("UPDATE tablo_haberler SET Resim=%s, BuyukResim=%s, Baslik=%s, KisaBilgi=%s, Detay=%s, Tarih=%s, SiraNo=%s, Slider=%s, Kategori=%s WHERE ID=%s",
                       escape($Resim, "text"),
                       escape($BuyukResim, "text"),
                       escape($_POST['Baslik'], "text"),
                       escape($_POST['KisaBilgi'], "text"),
...
$query_rsDetay = sprintf("SELECT * FROM tablo_haberler WHERE ID = %s", escape($ID, "int"));
                ...
                <div class="tab-pane active" id="bilgilerim">
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Ana Resim</label>
                        <div class="col-sm-10">
                      ...
                      <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Büyük Resim</label>
                        <div class="col-sm-10">
                              <div class="custom-file">
